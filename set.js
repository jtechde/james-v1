...
module.exports = { session: process.env.SESSION_ID || '',
    ...
    CAPTION : process.env.CAPTION || "JAMES-V2",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254785016388",              
    ...
    BOT : process.env.BOT_NAME || 'JAMES V2',
    URL : process.env.BOT_MENU_LINKS || 'https://telegra.ph/file/17c83719a1b40e02971e4.jpg',
    URL: process.env.URL || "https://files.catbox.moe/rjkqfo.jpg",
